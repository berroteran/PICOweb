...
import org.jug.nicaragua.picoweb.view.DashboardEdit.DashboardEditListener;
...
public final class DashboardView extends Panel implements View, DashboardEditListener {
  ...
  private Component buildHeader() {
    ...
    titleLabel = new Label("Dashboard (Pantalla principal con alertas o indicaadores)");
  ...
  private Component createContentWrapper(final Component content) {
    ...
    root.addItem("Configuracion", new Command() {
      @Override
      public void menuSelected(final MenuItem selectedItem) {
  ...
  private void openNotificationsPopup(final ClickEvent event) {
    ...
    Collection<DashboardNotification> notifications = PICOWEBUI.getDataProvider().getNotifications();
    PICOWEBEventBus.post(new NotificationsCountUpdatedEvent());
    ...
    Button showAll = new Button("Ver todas las Notificaciones", new ClickListener() {
      @Override
      public void buttonClick(final ClickEvent event) {
  ...
  public static final class NotificationsButton extends Button {
    ...
    public void updateNotificationsCount(final NotificationsCountUpdatedEvent event) {
      setUnreadCount(PICOWEBUI.getDataProvider().getUnreadNotificationsCount());
    }
