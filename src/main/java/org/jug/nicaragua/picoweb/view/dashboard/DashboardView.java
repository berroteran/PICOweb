package org.jug.nicaragua.picoweb.view.dashboard;

import java.util.Collection;
import java.util.Iterator;
import org.jug.nicaragua.picoweb.PICOWEBUI;
import org.jug.nicaragua.picoweb.domain.DashboardNotification;
import org.jug.nicaragua.picoweb.view.dashboard.DashboardEdit.DashboardEditListener;
...
public final class DashboardView extends Panel implements View, DashboardEditListener {
  ...
  private Component buildTopGrossingMovies() {
    Component topGrossingMoviesChart = new Header("Esto es un titulo de topGrossingMoviesChart");
