...
public final class EvaluadoresView extends VerticalLayout implements View {
  ...
  private static final Logger logger = LoggerFactory.getLogger(EvaluadoresView.class);
