  ...
  public TransactionsListing(final Collection<Transaction> transactions) {
    ...
    if (transactions != null) {
      for (Transaction transaction : transactions) {
        ...
        Label content = new Label(df.format((transaction.getTime())) + "<br>" + transaction.getCity() + ", " + transaction.getCountry());
        ...
        content = new Label("Seats: " + transaction.getSeats() + "<br>" + "Revenue: $" + new DecimalFormat("#.##").format(transaction.getPrice()), ContentMode.HTML);
        content.setSizeUndefined();
