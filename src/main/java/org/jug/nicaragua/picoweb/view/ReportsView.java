...
import org.jug.nicaragua.picoweb.view.ReportEditor.PaletteItemType;
import org.jug.nicaragua.picoweb.view.ReportEditor.ReportEditorListener;
...
public final class ReportsView extends TabSheet implements View, CloseHandler, ReportEditorListener {
  ...
  private Component buildDrafts() {
    ...
    Label draftsTitle = new Label("Borradores");
  ...
  private Component buildDraftThumb() {
    ...
    delete.setDescription("Borrar draft");
  ...
  private Component buildCreateBox() {
    ...
    Button create = new Button("Nuevo");
  ...
  public void addReport(final ReportType reportType, final Object prefillData) {
    ...
    PICOWEBEventBus.post(new ReportsCountUpdatedEvent(getComponentCount() - 1));
  ...
  public void onTabClose(final TabSheet tabsheet, final Component tabContent) {
    ...
    Button ok = new Button("Guardar", new ClickListener() {
      @Override
      public void buttonClick(final ClickEvent event) {
        confirmDialog.close();
