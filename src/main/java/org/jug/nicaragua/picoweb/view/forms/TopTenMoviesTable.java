...
public final class TopTenMoviesTable extends Table {
  ...
  public TopTenMoviesTable() {
    ...
    List<MovieRevenue> movieRevenues = new ArrayList<MovieRevenue>(PICOWEBUI.getDataProvider().getTotalMovieRevenues());
    ...
    setContainerDataSource(new BeanItemContainer<MovieRevenue>(MovieRevenue.class, movieRevenues.subList(0, 10)));
