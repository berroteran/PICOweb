package org.jug.nicaragua.picoweb.view.reports;

import java.text.SimpleDateFormat;
import java.util.Collection;
import java.util.Iterator;
import org.jug.nicaragua.picoweb.domain.Transaction;
import org.jug.nicaragua.picoweb.view.forms.InlineTextEditor;
import org.jug.nicaragua.picoweb.view.forms.TopTenMoviesTable;
import org.jug.nicaragua.picoweb.view.forms.TransactionsListing;
...
public final class ReportEditor extends VerticalLayout {
    ...
    paletteLayout.addLayoutClickListener(new LayoutClickListener() {
      ...
      public void layoutClick(final LayoutClickEvent event) {
        if (event.getChildComponent() != null) {
          PaletteItemType data = (PaletteItemType) ((DragAndDropWrapper) event.getChildComponent()).getData();
          addWidget(data, null);
        }
      }
    });
  ...
  private Component buildPaletteItem(final PaletteItemType type) {
    Label caption = new Label(type.getIcon().getHtml() + type.getTitle(), ContentMode.HTML);
    ...
    private class ReorderLayoutDropHandler implements DropHandler {
      ...
      public void drop(final DragAndDropEvent dropEvent) {
        ...
        if (sourceComponent.getParent() != layout) {
          ...
          AbstractComponent c = new WrappedComponent(createComponentFromPaletteItem((PaletteItemType) paletteItemType, null));
  ...
  public enum PaletteItemType {
    TEXT("Text Block", FontAwesome.FONT), TABLE("Top 10 Movies", FontAwesome.TABLE), CHART("Top 6 Revenue", FontAwesome.BAR_CHART_O), TRANSACTIONS("Latest transactions", null);
