...
import org.jug.nicaragua.picoweb.view.PantallasViewType;
...
public class PantallaPrincipal extends Navigator {

  // Provide a Google Analytics tracker id here
  private static final String TRACKER_ID = null;// "TODO poner traacker ID UA-658457-6";
  private GoogleAnalyticsTracker tracker;

  private static final PantallasViewType ERROR_VIEW = PantallasViewType.DASHBOARD;
  private ViewProvider errorViewProvider;

  public PantallaPrincipal(final ComponentContainer container) {
  ...
  private void initViewChangeListener() {
    addViewChangeListener(new ViewChangeListener() {
      ...
      public void afterViewChange(final ViewChangeEvent event) {
        PantallasViewType view = PantallasViewType.getByViewName(event.getViewName());
        // Appropriate events get fired after the view is changed.
        PICOWEBEventBus.post(new PostViewChangeEvent(view));
  ...
  private void initViewProviders() {
    ...
    for (final PantallasViewType viewType : PantallasViewType.values()) {
